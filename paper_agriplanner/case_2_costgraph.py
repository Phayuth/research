...
def cost_graph_multi():
    ...
    i = (
        path
        + "env_RobotArm2DRRRSimulator_types_Multi_planner_12_withlocgap_False_costgraph.pkl"
    )
    j = (
        path
        + "env_RobotArm2DRRRSimulator_types_Multi_planner_16_withlocgap_False_costgraph.pkl"
    )
    k = (
        path
        + "env_RobotArm2DRRRSimulator_types_Multi_planner_13_withlocgap_False_costgraph.pkl"
    )

    l = (
        path
        + "env_RobotArm2DRRRSimulator_types_Multi_planner_12_withlocgap_True_costgraph.pkl"
    )
    m = (
        path
        + "env_RobotArm2DRRRSimulator_types_Multi_planner_16_withlocgap_True_costgraph.pkl"
    )
    n = (
        path
        + "env_RobotArm2DRRRSimulator_types_Multi_planner_13_withlocgap_True_costgraph.pkl"
    )
    ...
    plt.savefig("~/exp2_costplot.svg", bbox_inches="tight")
    # plt.savefig("~/exp2_costplot.png", bbox_inches="tight")
    # plt.savefig("~/exp2_costplot.pdf", bbox_inches="tight")
    # plt.show()
