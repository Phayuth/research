...
def __taskspace_pose_in_dhframe(taskH):
    taskH_dh = []
    for H in taskH:
...
def solve_ik_(taskH):
    taskH_dh = __taskspace_pose_in_dhframe(taskH)
    num_sols, ik_sols = util.solve_ik_bulk(robot, taskH_dh)
    return num_sols, ik_sols


def example_solve_noaltconfig_bulletview():
...
if __name__ == "__main__":
    example_solve_noaltconfig_bulletview()
